...
public class BarcodeScanActivity extends AppCompatActivity {
    ...
    private String delegate_id="", delegate_name,user_id,event_id,card_type="", serial="", card_number="";
   ...
   Button btn_submit;
    ...
    private void initViews() {
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String user_id=Shared_Preferences.getPrefs(BarcodeScanActivity.this,Constants.REG_ID);
    ...
    private void submitData(String barcode_value, String user_id) {
        ...
        Log.d("DATATEST", "submitData: "+Shared_Preferences.getPrefs(BarcodeScanActivity.this, Constants.LEAD_USER_ID));
        ...
        Call<ResponseBody> responseBodyCall=getOrderAPI.submitData(
                Shared_Preferences.getPrefs(BarcodeScanActivity.this, Constants.LEAD_USER_ID),
                barcode_value);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(result)
                    {
                        ...
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BarcodeScanActivity.this);
                        ...
                        Toast.makeText(BarcodeScanActivity.this, message, Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(BarcodeScanActivity.this, message, Toast.LENGTH_SHORT).show();
                    }
                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                card_number = String.valueOf(separated1[3]);
                                Log.d("cardnumber", "run: "+card_number);
                                 Log.d("my_tag", "run: " + intentData);


                                txtBarcodeValue.setText(card_number);
                                Shared_Preferences.setPrefs(BarcodeScanActivity.this, Constants.BARCODE, card_number);
