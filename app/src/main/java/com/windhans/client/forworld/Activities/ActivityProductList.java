...
public class ActivityProductList extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_buisness_listing);
        ...
        //Toast.makeText(this, "Testing Pagination", Toast.LENGTH_SHORT).show();
  ...
  /*  @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView = (androidx.appcompat.widget.SearchView) myActionMenuItem.getActionView();
    ...
    private void getProductData() {
        progressDialog.show();
        //productList.clear();
        String user_id= Shared_Preferences.getPrefs(ActivityProductList.this, Constants.REG_ID);
        String buisness_id= Shared_Preferences.getPrefs(ActivityProductList.this, Constants.BUSINESS_ID);
        String subcategory=   Shared_Preferences.getPrefs(ActivityProductList.this, Constants.SUBCATEGORY);
        ...
        final Call<ResponseBody> result = (Call<ResponseBody>) api.getRecommended(
                Shared_Preferences.getPrefs(ActivityProductList.this, Constants.REG_ID),
                Shared_Preferences.getPrefs(ActivityProductList.this, Constants.SUBCATEGORY),
                query,
                page_count);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final MenuItem menuItem1 = menu.findItem(R.id.search_home);

        menuItem1.setVisible(true);

        if(Shared_Preferences.getPrefs(ActivityProductList.this, Constants.REG_TYPE).equals("2")){
        ...
        mSearchView = (androidx.appcompat.widget.SearchView) menuItem1.getActionView();
        EditText searchEditText = (EditText) mSearchView.findViewById(R.id.search_src_text);
        searchEditText.setTextColor(getResources().getColor(R.color.white));
        searchEditText.setHintTextColor(getResources().getColor(R.color.white));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_cart: {
                Intent intent = new Intent(ActivityProductList.this, Activity_My_Cart.class);
           ...
           /* case R.id.search_home: {
            ...
            case R.id.search_home: {
                ...
                mSearchView = (androidx.appcompat.widget.SearchView) item.getActionView();
                EditText searchEditText = (EditText) mSearchView.findViewById(R.id.search_src_text);
                searchEditText.setTextColor(getResources().getColor(R.color.white));
                searchEditText.setHintTextColor(getResources().getColor(R.color.white));
