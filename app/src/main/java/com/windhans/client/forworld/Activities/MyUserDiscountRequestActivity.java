...
public class MyUserDiscountRequestActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    private List<MyDiscountRequest> myDiscountRequestArrayList = new ArrayList<>();
    private List<MyDiscountRequest> filterdmyDiscountRequestArrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private ProgressDialog progressDialog;
    private MyVendorDiscountRequstListAdapter mAdapter;
  ...
  //  private LeadList product;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_user_vendor_request);
...
//        final FragmentManager fragmentManager = getFragmentManager();
        recyclerView = (RecyclerView) findViewById(R.id.recycler_my_request);


        mAdapter = new MyVendorDiscountRequstListAdapter(myDiscountRequestArrayList);
...
//        }
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.SSWORLD + "/get_my_qr_request_by_user")
    ...
    private void getEnquiriesData() {
        ...
        progressDialog.show();
        filterdmyDiscountRequestArrayList.clear();
        MyUserDiscountRequestActivity.GetOrderAPI api = MyConfig.getRetrofit(MyConfig.JSON_BASE_URL).create(MyUserDiscountRequestActivity.GetOrderAPI.class);
                    ...
                    if (res) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                myDiscountRequestArrayList.add(new MyDiscountRequest(obj));
                        ...
                        Toast.makeText(MyUserDiscountRequestActivity.this, "" + jsonObject.getString("reason"), Toast.LENGTH_SHORT).show();
                    }
