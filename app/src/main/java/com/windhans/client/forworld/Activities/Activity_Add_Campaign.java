...
public class Activity_Add_Campaign extends UtilityRuntimePermission implements View.OnClickListener, com.windhans.client.forworld.my_library.Camera.AsyncResponse {
    ...
    private com.windhans.client.forworld.my_library.Camera camera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__add__campaign);
        ...
        title.setText("Add New Campaign");
    ...
    private void getViews() {
        ...
        edt_fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Activity_Add_Campaign.this, date, myCalendar
        ...
        edt_todate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Activity_Add_Campaign.this, date1, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
            ...
            public void onClick(View view) {
                if (isValid()) {
                    if (profile_image_path == null) {
                        Toast.makeText(Activity_Add_Campaign.this, "Please Select Profile Pic", Toast.LENGTH_SHORT).show();
                    } else {
                        progressDialog = new ProgressDialog(Activity_Add_Campaign.this);
                    ...
                    Toast.makeText(Activity_Add_Campaign.this, "Please Fill Complete Data", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadFile(String profile_image_path, String profile_image_name) {
        ...
        RequestBody campaign_id = RequestBody.create(MediaType.parse("text/plain"), "");
        RequestBody action = RequestBody.create(MediaType.parse("text/plain"), "insert");
        RequestBody user_id = RequestBody.create(MediaType.parse("text/plain"), Shared_Preferences.getPrefs(Activity_Add_Campaign.this, Constants.REG_ID));
        RequestBody business_id = RequestBody.create(MediaType.parse("text/plain"), Shared_Preferences.getPrefs(Activity_Add_Campaign.this, Constants.BUSINESS_ID));
        RequestBody ads_unit_id = RequestBody.create(MediaType.parse("text/plain"), "123");
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (res) {
                        ...
                        Toast.makeText(Activity_Add_Campaign.this, reason, Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    } else
                        Toast.makeText(Activity_Add_Campaign.this, "" + reason, Toast.LENGTH_SHORT).show();
                    onBackPressed();
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.ll_upload_image) {
            if (Activity_Add_Campaign.super.requestAppPermissions(this))
