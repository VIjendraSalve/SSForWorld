...
public class ImagePOJO implements Parcelable {
    ...
    public ImagePOJO(String img_id, String img_name, MultipartBody.Part image_path_multipart, String img_path_local) {
        this.img_id = img_id;
    ...
    public ImagePOJO(JSONObject jsonObject, int image_type) {
