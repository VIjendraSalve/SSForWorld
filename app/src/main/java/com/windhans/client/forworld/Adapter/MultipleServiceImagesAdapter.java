...
public class MultipleServiceImagesAdapter extends RecyclerView.Adapter<MultipleServiceImagesAdapter.MyViewHolder> {
    Context context;
    View view;
    ...
    public MultipleServiceImagesAdapter(Context context, ArrayList<Service_Images> imageList, RecyclerViewItemInterface recyclerViewItemInterface) {
    ...
    @Override
    public MultipleServiceImagesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.multipleimage_service_list_view, parent, false);
        MultipleServiceImagesAdapter.MyViewHolder holder = new MultipleServiceImagesAdapter.MyViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(MultipleServiceImagesAdapter.MyViewHolder holder, final int position) {
        ...
        holder.iv_images_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                deleteImage(imageList.get(position).getImage_id());
            }
        });
