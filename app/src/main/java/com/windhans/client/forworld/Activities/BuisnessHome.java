...
public class BuisnessHome extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        ...
        recycler_view =findViewById(R.id.recycler_view);
         ...
         mAdapter = new DashboardAdapter(this,categoryModelList,recycler_view);
        ...
        responseBodyCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    Log.d("CategoryList", "onResponse: "+output);
